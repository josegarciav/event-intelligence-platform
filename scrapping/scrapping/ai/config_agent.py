...
class UrlHint:
    ...
    is_js_heavy: Optional[bool] = None
    discovered_link_patterns: Optional[List[str]] = None  # regexes
    title_selector_guess: Optional[str] = None
    text_selector_guess: Optional[str] = None
...
class ConfigAgent:
    ...
    def propose_for_urls(
        ...
        *,
        ...
        hints: Optional[Sequence[UrlHint]] = None,
    ) -> Dict[str, Any]:
        """
    ...
    def _decide_engine(self, urls: Sequence[str], *, hints: Optional[Sequence[UrlHint]] = None) -> Tuple[str, float, List[str]]:
        """

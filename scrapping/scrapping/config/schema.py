...
class RateLimitPolicy(BaseModel):
    rps: Optional[float] = Field(default=None, ge=0.0)
    burst: Optional[int] = Field(default=None, ge=1)
    min_delay_s: Optional[float] = Field(default=None, ge=0.0)
    jitter_s: Optional[float] = Field(default=None, ge=0.0)
...
class EngineConfig(BaseModel):
    ...
    browser: Optional[str] = Field(default=None, description="seleniumbase|playwright")
    headless: bool = True
...
class BrowserAction(BaseModel):
    ...
    timeout_s: Optional[float] = Field(default=None, ge=0.0)
...
class StorageTarget(BaseModel):
    ...
    path: Optional[str] = None  # if None, library decides default layout
...
ConfigFile = Union[SourceConfig, List[SourceConfig]]

import pytest
from scrapping.diagnostics.classifiers import diagnose_http_response, diagnose_rendered_dom, DiagnosisLabel, NextStep
...
def test_diagnose_ok():
    res = diagnose_http_response(200, {}, text="<html><body><h1>Title</h1><p>Content goes here...</p></body></html>" * 10)

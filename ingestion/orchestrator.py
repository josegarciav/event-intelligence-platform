...
from ingestion.base_pipeline import BasePipeline, PipelineConfig, PipelineExecutionResult, PipelineStatus
...
class PipelineOrchestrator:
    ...
    def register_pipeline(self, source_name: str, pipeline_class: Type[BasePipeline],
    ...
    def get_execution_history(self, source_name: Optional[str] = None,
                              limit: int = 10) -> List[PipelineExecutionResult]:
        """
    ...
    def get_latest_execution(self, source_name: str) -> Optional[PipelineExecutionResult]:
    ...
    def get_execution_stats(self, source_name: Optional[str] = None) -> Dict:
        ...
        return {
            ...
            "average_success_rate": (total_successful / total_events * 100) if total_events > 0 else 0,
